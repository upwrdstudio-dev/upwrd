      ...
      <div className="max-w-6xl mx-auto px-6">
          ...
          {tiers.map((t, i) => (
            <Reveal key={t.tag} delay={i * 0.1}>
              <motion.div
                ...
                className="rounded-2xl border border-line p-8 hover:border-teal/40 hover:shadow-lg hover:shadow-navy/5 transition-[border-color,box-shadow] duration-300"
              >
        ...
        <Reveal delay={0.3}>
          <div className="relative rounded-2xl bg-navy p-8 md:p-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6 overflow-hidden">
            {/* Slow ambient glow sweep — signals "this one's special" without being loud */}
            <motion.div
